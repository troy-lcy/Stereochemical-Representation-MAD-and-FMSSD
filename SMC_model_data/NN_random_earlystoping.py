    ...
    for epoch in range(EPOCHS):
        ...
        if r2_test > best_r2:
            ...
            if epochs_since_best >= patience:
                ...
                np.savetxt('MAD_random_best_r2_'+ '.csv',best_total,delimiter=',')
                np.savetxt('MAD_random_test_target_pred_'+ '.csv',target_pred_test,delimiter=',')
                np.savetxt('MAD_random_r2_'+ '.csv', r2_test_total,delimiter=',')               
                break  # 提前停止训练
