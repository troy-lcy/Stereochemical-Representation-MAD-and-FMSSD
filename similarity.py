...
complex('./molecule sdf/BHA/aryl halide/',
        ['BHA/aryl_halide.csv','BHA/aryl_halide.png'],
        'BHA')

complex('./molecule sdf/BHA/base/',
        ['BHA/base.csv','BHA/base.png'],
        'BHA')

complex('./molecule sdf/BHA/ligand/',
...
score_2 = score(OUT + 'BHA/aryl_halide.csv')
...
spider_plots(['additive\n(58.70)','aryl halide\n(47.72)','ligand\n(62.85)','base\n(38.45)'],
              4,
              score_total,
              titles[0],
              './dataset similarity/BHA/')
